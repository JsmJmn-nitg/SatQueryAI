    ...
    try {
      ...
      if (activeTab === "Autofetch") {
        setAnalysisResult((prev) => ({
          ...prev,
          title: "Inferred Region Land-Cover Overview",
          summary:
            "This analysis is based on automatically fetched satellite data for your area of interest. The region shows a mix of urban, agricultural, and natural land-cover types.",
          executionTrace: {
            task: "autofetch_orchestration",
            inputs: { mode: "Autofetch", query },
            tools_used: [
              { name: "NLP_Entity_Resolver", params: { target_region: "Extracted from query" } },
              { name: "SentinelHub_AutoFetch", params: { sensor: "Sentinel-2 L2A" } }
            ],
            notes: ["Autonomous pipeline completed without manual coordinates."]
          }
        }));
      }
    } finally {
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto">
        ...
        <div className="p-8 max-w-7xl w-full mx-auto space-y-6">
          ...
          <div className={`relative p-6 rounded-2xl border overflow-hidden ${
            darkMode
              ? "bg-gradient-to-b from-[#11172E] to-[#0D1224] border-[#1C2648]"
